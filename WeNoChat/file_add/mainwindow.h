...
public:
    ...
    ~MainWindow();
    void pushFileIntoChatWindow(bool type,QString filePath, QString msg, QString time, QImage *image = NULL, bool isSending = false);
    void dealFile(ChatMessageWidget *messageW, QListWidgetItem *item,QString filePath, QString text, QString time, ChatMessageWidget::User_Type type, QImage *image);
